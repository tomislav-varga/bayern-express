          ...
          <div className="md:w-1/2">
            ...
            <div className="grid grid-cols-2 gap-6 mb-8">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">24/7 Notdienst</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Zertifiziert</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Erfahrenes Team</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Hohe Kundenzufriedenheit</span>
              </div>
            </div>
